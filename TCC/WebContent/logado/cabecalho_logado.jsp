...
<ul class="nav">
	...
	<li><a href="/TCC/mvc?logica=PainelLogica"><i class="icon-user"></i><br />Painel</a></li>
	<li><a href="/TCC/mvc?logica=LogoutLogica"><i class="icon-off"></i><br/>Sair</a></li>
	...
	<li><i class="icon-user"></i><br/>Usuario: ${usuario.login}
</ul><br>
